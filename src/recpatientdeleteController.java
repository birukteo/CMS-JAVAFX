...
public class recpatientdeleteController implements Initializable {
    ...
    private void handlemouseaction(MouseEvent event) {
        ...
        patient rec = tableviewpatient.getSelectionModel().getSelectedItem();
    ...
    public void showpatientlist() {
        ...
        tableviewpatient.setItems(list);
    ...
    private void deleterecord() {
        String query = "DELETE FROM patient WHERE id = " + IDTextField.getText() + "";
        executeQuery(query);
        showpatientlist();
